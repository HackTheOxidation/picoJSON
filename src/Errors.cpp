...
namespace picoJSON {
SyntaxException::SyntaxException(string &msg)
    : msg_(msg), suggestion_(""), line_(0) {}

SyntaxException::SyntaxException(string &msg, unsigned int line)
    : msg_(msg), suggestion_(""), line_(line) {}

SyntaxException::SyntaxException(string &msg, string suggestion)
    : msg_(msg), suggestion_(suggestion), line_(0) {}
